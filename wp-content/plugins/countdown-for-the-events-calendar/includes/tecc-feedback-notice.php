...
if (!class_exists('teccFeedbackNotice')) {
	...
	public function load_script() {
		wp_register_script( 'tecc-feedback-notice-script', TECC_JS_DIR. '/tecc-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'tecc-feedback-notice-script' );
        wp_register_style( 'tecc-feedback-notice-styles',TECC_CSS_URL.'/tecc-admin-feedback-notice.css' );
   ...
   // admin notice  
    public function tecc_admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        $img_path=TECC_PLUGIN_URL.'assets/images/tecc-logo.jpg';
        ...
        <ul>
            ...
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button tecc_dismiss_notice" title="%7$s">%7$s</a></li>
            <li class="buy_pro"><a
