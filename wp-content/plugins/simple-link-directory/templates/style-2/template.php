<?php wp_enqueue_style('sld-css-style-2' ); ?>
...
if ( $list_query->have_posts() ) 
{
	...
	while ( $list_query->have_posts() ) 
	{
		...
		$customcss = '';
		$customcss .= '#qcopd-list-'.$listId .'-'. get_the_ID().'.style-2 .ca-menu li .ca-main {';
		if($title_font_size!=''){
		...
		$customcss .= '}';
		$customcss .= '#qcopd-list-'. $listId .'-'. get_the_ID().'.style-2 .ca-menu li .ca-sub {';
		...
		$customcss .= '}';
		wp_add_inline_style( 'sld-css-style-2', $customcss );
		...
		<div id="qcopd-list-<?php echo esc_attr($listId) .'-'. esc_attr(get_the_ID()); ?>" class="qcopd-list-column <?php echo esc_attr($style); ?>">
			...
			<div class="qcopd-single-list-1">
				...
				<ul class="ca-menu">
					...
					?>
					<li id="item-<?php echo esc_attr(get_the_ID()) ."-". esc_attr($count); ?>">
						<?php 
