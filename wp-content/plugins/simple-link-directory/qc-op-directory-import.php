								...
								if ( $movefile && ! isset( $movefile['error'] ) ) {
									...
									while(($data = fgetcsv($file)) !== FALSE) 
									{
										...
										$baseData[$data[0]][] = array(
											...
											'qcopd_item_title' => sanitize_text_field(iconv(mb_detect_encoding($data[1]), "UTF-8", $data[1])),
											'qcopd_item_link' => esc_url_raw(iconv(mb_detect_encoding($data[2]), "UTF-8", $data[2])),
											'qcopd_item_img' => '',
