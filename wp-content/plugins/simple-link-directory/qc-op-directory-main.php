...
function promo_link_in_cpt_table()
{
    ...
    {   
        $link = '<div class="alignleft actions"><a href="'.esc_url("https://www.quantumcloud.com/simple-link-directory/").'" target="_blank" class="button qcsld-promo-link">Upgrade to Pro</a></div>';
    }
    ...
    if ( is_admin() && ($screen->post_type == 'sld') ) {
        ...
        <div class="notice notice-info is-dismissible sld-notice" style="display:none"> 
            <div class="sld_info_carousel">
                ...
                <div class="sld_info_item">**SLD Pro Tip: Did you know that you can <strong style="color: yellow">Auto Generate</strong> Title, Subtitle & Thumbnail with the Pro Version in Just 2 Clicks? <strong style="color: yellow">Triple Your Link Entry Speed!</strong></div>
                
                <div class="sld_info_item">**SLD Tip: Lists are the base pillars of SLD, not individual links. Group your links into different Lists for the best performance.</div>
                
                <div class="sld_info_item">**SLD Tip: SLD looks the best when you create multiple Lists and use the Show All Lists mode.</div>

                <div class="sld_info_item">**SLD Pro Tip: Did you know that SLD Pro version lets you monetize your directory and earn <strong style="color: yellow">passive income?</strong> Upgrade now!</div>
                
                <div class="sld_info_item">**SLD Tip: Try to keep the maximum number of links below 30 per list. Create multiple Lists as needed.</div>

                <div class="sld_info_item">**SLD Tip: Use the handy shortcode generator to make life easy. It is a small, blue [SLD] button found at the toolbar of any page's visual editor.</div>
                
                <div class="sld_info_item">**SLD Pro Tip: You can display your <strong style="color: yellow">Lists by category </strong>with the SLD pro version. <strong style="color: yellow">16+ Templates, Multi page mode</strong>, Widgets are also available.</div>
                
                <div class="sld_info_item">**SLD Tip: You can create a page with a contact form and link the Add Link button to that page so people can submit links to your directory by email.</div>

                <div class="sld_info_item">**SLD Tip: If you are having problem with adding more items or saving a list then you may need to increase max_input_vars value in server. Check the help section for more details.</div>
                
                <div class="sld_info_item">**SLD Pro Tip: SLD pro version has <strong style="color: yellow">front end dashboard</strong> for user registration and link management. As well as tags and instant search. <strong style="color: yellow">Upgrade to the Pro version now!</strong></div>
...
{					                  // --- Parameters: ---
    add_meta_box( 'qc-sld-meta-box-id', // ID attribute of metabox
                  'Shortcode Generator for SLD',       // Title of metabox visible to user
...
function sld_meta_box_callback( $post )
{
    ...
    <p>
		...
		<input type="button" id="sld_shortcode_generator_meta" class="button button-primary button-large" value="Generate Shortcode" />
    </p>
